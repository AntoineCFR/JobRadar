...
MATCH_INSTRUCTIONS = (
    ...
    "NEAR-DISQUALIFYING: high-severity blocker; this ALONE caps the score ~8-15, and if "
    "the ROLE is ALSO a poor fit, go LOWER (down to ~5).\n"
...
CALIBRATE_INSTRUCTIONS = (
    ...
    "required C1/C2/fluent/'Excellent' = near-disqualifying (cap ~8-15, and LOWER, down "
    "to ~5, if the role ALSO mismatches), keep as high-severity blocker; required B2 = "
